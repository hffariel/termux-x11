...
public class TouchParser {
    ...
    boolean onTouchEvent(MotionEvent ev) {
        Toast.makeText(target.getRootView().findViewById(android.R.id.content).getContext(), "pcount:"+ev.getPointerCount()+ " ptidx:" + ev.getActionIndex()+ " action: "+ev.getAction()+ " buttonstate: "+ev.getButtonState(), Toast.LENGTH_SHORT).show();
    ...
    private class HardwareMouseListener {
        ...
        boolean onTouch(MotionEvent e) {
            if (e.getAction() == MotionEvent.ACTION_SCROLL || (e.getSource() == 12290 && (e.getPointerCount() > 1))) {
            ...
            if (e.getSource() == 12290 && ((e.getAction() == 0 && e.getPointerCount() <= 1) || (e.getAction() == 2 && e.getPointerCount() <= 1))) {
                currentBS = 1;
            }
            if (e.getSource() == 12290 && (e.getAction() == 0 && e.getPointerCount() > 1)) {
                currentBS = 2;
            }
