...
public class TouchParser {
    ...
    boolean onTouchEvent(MotionEvent ev) {
        // Toast.makeText(target.getRootView().findViewById(android.R.id.content).getContext(), "pcount:"+ev.getPointerCount()+ " mask: "+ev.getActionMasked()+ " action: "+ev.getAction()+ " buttonstate: "+ev.getButtonState(), Toast.LENGTH_SHORT).show();
